-- Bank Ads Engine - Neon PostgreSQL Schema (UUIDs)
...
-- Publishers Sub-Type (extends users essentially)
CREATE TABLE IF NOT EXISTS publishers (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    user_id UUID UNIQUE REFERENCES users(id) ON DELETE CASCADE,
    category VARCHAR(100) NOT NULL,
    subaccount_code VARCHAR(100), -- Paystack Split ID
    recipient_code VARCHAR(100), -- Paystack Transfer ID
